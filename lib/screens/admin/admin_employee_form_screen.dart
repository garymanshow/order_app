...
class _AdminEmployeeFormScreenState extends State<AdminEmployeeFormScreen> {
  ...
  Future<bool> _isPhoneUnique(String phone, [String? currentPhone]) async {
    final authProvider = Provider.of<AuthProvider>(context, listen: false);

    final exists = authProvider.clientData!.clients
        .whereType<Employee>()
        .any((e) => e.phone == phone && e.phone != currentPhone);
  ...
  Future<void> _saveEmployee() async {
    ...
    try {
      ...
      // Проверка уникальности телефона
      if (!await _isPhoneUnique(normalizedPhone, widget.employee?.phone)) {
        _showSnackBar(
            'Сотрудник с таким телефоном уже существует', Colors.orange);
        return;
      }
                            ...
                            TextFormField(
                              ...
                              validator: (value) {
                                if (_twoFactorAuth &&
                                  ...
                                  return 'Email обязателен при включенной 2FA';
                                }
                                return null;
                              },
                            ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SwitchListTile(
                              ...
                              subtitle: const Text(
                                'Требовать подтверждение по email при входе',
