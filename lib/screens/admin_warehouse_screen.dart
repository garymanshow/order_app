...
import 'package:intl/intl.dart'; // 👈 ДОБАВЛЕНО для DateFormat
// import 'package:shared_preferences/shared_preferences.dart'; // 👈 УДАЛЕНО
// import 'dart:convert'; // 👈 УДАЛЕНО
import '../providers/auth_provider.dart';
import '../services/api_service.dart';
import '../models/warehouse_operation.dart';
// import '../models/product.dart'; // 👈 УДАЛЕНО (не используется)
...
class _AdminWarehouseScreenState extends State<AdminWarehouseScreen> {
  ...
  // List<Product> _products = []; // 👈 УДАЛЕНО (не используется)
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      // Загружаем продукты для автодополнения (опционально)
      // _products = authProvider.clientData?.products ?? [];

      // Загружаем операции склада (нужно добавить в ClientData)
